...
function installStyles() {
  ...
  style.textContent = `
.site-controls{display:flex;align-items:center;justify-content:center;gap:12px;flex-wrap:wrap;width:100%;margin:.65rem 0 .15rem}.lang-switch{display:flex;gap:2px;padding:3px;border:1px solid var(--border,#d9dee7);border-radius:999px;background:var(--panel,#fff)}.lang-switch button{border:0;background:transparent;border-radius:999px;padding:7px 11px;font:inherit;font-weight:700;cursor:pointer}.lang-switch button.active{background:var(--accent,#2563eb);color:#fff}.x-follow{width:190px;min-height:72px;box-sizing:border-box;display:flex;flex-direction:column;align-items:center;justify-content:flex-start;gap:2px;padding:7px 14px 8px;border-radius:18px;background:#000;color:#fff;text-decoration:none;font-weight:800;line-height:1.1;box-shadow:0 2px 8px #0002;transition:transform .15s ease,box-shadow .15s ease}.x-follow:hover{transform:translateY(-1px);box-shadow:0 5px 14px #0003}.x-profile-row{display:flex;align-items:center;justify-content:center;gap:8px;width:100%;white-space:nowrap;min-height:30px}.x-pfp{width:28px;height:28px;border-radius:50%;object-fit:cover;background:#333}.x-handle{overflow:hidden;text-overflow:ellipsis;max-width:145px}.x-follow [data-x-label]{display:block;width:100%;text-align:center;font-size:.95rem;margin-top:1px}.x-follow:focus-visible,.lang-switch button:focus-visible{outline:2px solid var(--accent,#2563eb);outline-offset:2px}@media(max-width:700px){.site-controls{width:100%;margin:.45rem 0}.x-follow{flex:0 1 190px}.lang-switch{flex:none}}
`
