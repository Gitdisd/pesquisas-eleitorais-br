...
function installStyles() {
  ...
  style.textContent = `
.site-controls{display:flex;align-items:center;justify-content:center;gap:12px;flex-wrap:wrap;width:100%;margin:.65rem 0 .15rem}.lang-switch{display:flex;gap:2px;padding:3px;border:1px solid var(--border,#d9dee7);border-radius:999px;background:var(--panel,#fff)}.lang-switch button{border:0;background:transparent;border-radius:999px;padding:7px 11px;font:inherit;font-weight:700;cursor:pointer}.lang-switch button.active{background:var(--accent,#2563eb);color:#fff}.x-follow{width:235px;min-height:82px;box-sizing:border-box;display:flex;flex-direction:column;align-items:center;justify-content:flex-start;gap:3px;padding:7px 18px 8px;border-radius:999px;background:#000;color:#fff;text-decoration:none;font-family:Arial,sans-serif;font-weight:700;line-height:1.1;box-shadow:0 2px 8px #0002;transition:transform .15s ease,box-shadow .15s ease}.x-follow:hover{transform:translateY(-1px);box-shadow:0 5px 14px #0003}.x-profile-row{display:flex;align-items:center;justify-content:center;gap:8px;width:100%;white-space:nowrap;min-height:31px}.x-pfp{width:30px;height:30px;flex:0 0 30px;border-radius:50%;object-fit:cover;background:#333}.x-handle{font-size:16px;line-height:30px;white-space:nowrap;overflow:visible}.x-follow [data-x-label]{display:block;width:100%;text-align:center;font-size:16px;line-height:22px;margin-top:0}.x-follow:focus-visible,.lang-switch button:focus-visible{outline:2px solid var(--accent,#2563eb);outline-offset:2px}@media(max-width:700px){.site-controls{width:100%;margin:.45rem 0}.x-follow{width:235px;flex:0 1 235px}.lang-switch{flex:none}}
`
