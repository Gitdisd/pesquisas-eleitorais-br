...
function resolveWindowDays(presetId, customDays) {
  ...
  return WINDOW_PRESETS.find((x) => x.id === presetId)?.days ?? 14
}
...
const state = {
  ...
  rangeDays: null, projection: false, chart: null,
}
...
function shellHTML() {
  ...
  return `<header class="app-hdr"><div class="wrap"><div class="hdr-row"><div class="hdr-text">
    ...
    <div class="controls controls-primary">
      ...
      <div class="seg range-seg" role="group" aria-label="Período"><button type="button" data-range="30">30d</button><button type="button" data-range="90">90d</button><button type="button" data-range="all" class="active">tudo</button></div>
    </div>
    ...
    <div class="chart-below"><div class="controls controls-secondary">
      ...
      <label class="ctrl">personalizado <input type="number" class="win-custom" id="windowCustom" min="1" step="1" value="14" inputmode="numeric" /> <strong id="windowVal">14d</strong></label></div>
