...
| `src/models/advanced.ts` | models 3–7 | Rust statistical models | Rust implementations 3–7 migrated to shared core; production dispatcher remains |
| `src/models/school.ts` | models 8–12 | Rust statistical models | Rust school-center implementations 8–12 migrated to shared core; production dispatcher remains |
